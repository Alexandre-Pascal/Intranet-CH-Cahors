  ...
  return (
    <div>
      ...
      <div className={styles.container_buttons}>
        <button onClick={() => window.location.href = "./Administration/CreateRole?kind=create"} className="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded mt-4 mr-4">Créer un nouveau rôle</button>
